...
namespace Bi.Core.Extensions
{
    ...
    public static class ObjectExtensions
    {
        ...
        {
            return @this.ToJson(settings: null);
        }
        /// <summary>
        /// 对象序列化为json字符串(不改变格式)
        /// </summary>
        /// <param name="this">待序列化的对象</param>
        /// <returns>string</returns>
        public static string ToDefalutJson(this object @this)
        {
        ...
        /// </summary>
        /// <param name="this">待序列化的对象</param>
        /// <param name="options">JsonSerializerOptions配置</param>
        /// <returns></returns>
        ...
        public static string ToJson(this object @this, JsonSerializerSettings settings)
        {
            ...
            {
                ContractResolver = new JsonIgnoreAttributeContractResolver()
            });
        }
