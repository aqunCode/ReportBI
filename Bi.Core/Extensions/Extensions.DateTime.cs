...
namespace Bi.Core.Extensions
{
    ...
    public static class DateTimeExtensions
    {
        ...
        /// <param name="style">日期类型</param>
        /// <returns></returns>
        public static string ToYWWD(this string @this, IFormatProvider provider = null, DateTimeStyles style = DateTimeStyles.None)
        {
            DateTime reelDate = (DateTime)@this.ToDateTime("yyyyMMdd", provider, style);
            var dateCode = $"{reelDate:yy}{reelDate.WeekOfYear(DayOfWeek.Monday, lastFullWeek: false).ToString().PadLeft(2, '0')}";
            dateCode = dateCode.Substring(1) + reelDate.ToString("dd").ToLong().ToBase(31, "123456789ABCDEFGHJKLMNPQRSTUVWX");
            return dateCode;
        }
        #endregion
