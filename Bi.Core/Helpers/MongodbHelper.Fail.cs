...
//        /// 链接字符串
//        /// </summary>
//        private readonly string connectionString = ConfigHelper.GetValue<string>("Mongodb:ConnectionString") ?? "mongodb://localhost:27017";

//        /// <summary>
//        /// 数据库，若不存在，则自动创建
//        /// </summary>
//        private readonly string databaseName = ConfigHelper.GetValue<string>("Mongodb:Database") ?? "Database";
//        #endregion
