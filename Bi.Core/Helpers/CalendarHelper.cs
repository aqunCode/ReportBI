...
namespace Bi.Core.Helpers
{
    ...
    /// 日历帮助工具类（中国日历）
    /// 调用：
    /// CalendarHelper c = new CalendarHelper(new DateTime(1990, 01, 15));
    ...
    public class CalendarHelper
    {
        ...
        ///</remarks>
        private static int[] LunarDateArray = new[]
        {
        ...
        /// 用一个标准的公历日期来初使化
        /// </summary>
        public CalendarHelper(DateTime dt)
        {
        ...
        public CalendarHelper(int cy, int cm, int cd, bool leapMonthFlag)
        {
            int i, leap, Temp, offset;
        ...
        {
            if ((bitpostion > 31) || (bitpostion < 0)) throw new Exception("Error Param: bitpostion[0-31]:" + bitpostion.ToString());
